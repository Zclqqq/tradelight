...
export function TradeCalendar() {
  ...
  return (
    <div className="bg-card p-4 rounded-none shadow-sm h-full flex flex-col">
        ...
        {days.map((day) => {
          ...
          return (
            <div
              key={day.toString()}
              className={cn(
                "relative bg-card p-2 rounded-none flex flex-col justify-start text-xs border border-transparent",
